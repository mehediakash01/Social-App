...
export default function RightSidebar() {
  ...
  return (
    <aside className="hidden lg:block w-64 fixed right-4 top-20 h-[calc(100vh-6rem)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
